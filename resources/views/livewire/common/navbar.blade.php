        ...
        <nav class="navbar navbar-expand-lg navbar-light mt-2">
           <div class="collapse navbar-collapse ms-auto" id="navbarSupportedContent">
              ...
              <li class="nav-item ps-2"><a href="{{url('/')}}" class="nav-link">{{ __('frontend.home') }}</a></li>
                <li class="nav-item ps-2"><a href="{{ url('/sports') }}" class="nav-link"><i class="fas fa-football-ball me-1" style="color:#c9a84c"></i> Sports</a></li>
                <li class="nav-item ps-2"><a href="{{ url('/concerts') }}" class="nav-link"><i class="fas fa-music me-1" style="color:#c9a84c"></i> Concerts</a></li>
