  ...
  <div class="container">
     <div class="row">
        <div class="col-lg-2 navbar-light">
           <div class="logo"><a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('images/nomaly-logo.png')); ?>" alt="Nomaly Travel"></a></div>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
           <div class="nm-nav-panel" id="navbarSupportedContent">
              ...
              <li class="nav-item ps-2 d-lg-none"><a href="<?php echo e(url('/')); ?>" class="nav-link"><?php echo e(__('frontend.home')); ?></a></li>
              ...
              <li class="nav-item dropdown ps-2">
                ...
                <ul class="dropdown-menu" aria-labelledby="nmTravelDd">
                  <li><a class="dropdown-item" href="<?php echo e(url('/')); ?>#flights"><i class="fas fa-plane"></i> Flights</a></li>
                  <li><a class="dropdown-item" href="<?php echo e(url('/')); ?>#hotels"><i class="fas fa-hotel"></i> Hotels</a></li>
              ...
              <li class="nav-item dropdown ps-2">
                ...
                <ul class="dropdown-menu" aria-labelledby="nmEntDd">
                  <li><a class="dropdown-item" href="<?php echo e(url('/sports')); ?>"><i class="fas fa-football-ball"></i> Sports</a></li>
                  <li><a class="dropdown-item" href="<?php echo e(url('/concerts')); ?>"><i class="fas fa-music"></i> Concerts</a></li>
                </ul>
              </li>

              
              <li class="nav-item ps-2"><a href="<?php echo e(url('/services')); ?>" class="nav-link">Services</a></li>
              <li class="nav-item ps-2"><a href="<?php echo e(url('/blog')); ?>" class="nav-link">Blog</a></li>
              ...
              <li class="nav-item dropdown ps-2">
                ...
                <ul class="dropdown-menu" aria-labelledby="nmAboutDd">
                 ...
                 <li class="nav-item dropdown d-none d-lg-flex align-items-center" style="margin-left:12px; margin-right:8px;">
                   <a href="#" class="dropdown-toggle" id="userdata" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     <?php if(Laravel\Jetstream\Jetstream::managesProfilePhotos()): ?>
                       <img class="img-fluid" src="<?php echo e(Auth::user()->profile_photo_url); ?>" style="width:36px;height:36px;border-radius:50%;object-fit:cover;" />
                     <?php else: ?>
                       <img class="img-fluid" src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name[0])); ?>" style="width:36px;height:36px;border-radius:50%;object-fit:cover;" />
                     <?php endif; ?>
                   </a>
                 ...
                 <li class="nav-item d-lg-none">
                   <a href="<?php echo e(url('/dashboard')); ?>" class="nav-link"><i class="fas fa-tachometer-alt"></i> <?php echo e(__('frontend.dashboard')); ?></a>
                 </li>
                 <li class="nav-item d-lg-none">
                   <a href="<?php echo e(route('profile.show')); ?>" class="nav-link"><i class="fas fa-edit"></i> <?php echo e(__('frontend.my_profile')); ?></a>
                 </li>
                 <li class="nav-item d-lg-none">
                   <a href="<?php echo e(route('hotel-booking')); ?>" class="nav-link"><i class="fas fa-hotel"></i> <?php echo e(__('frontend.my_hotel_bookings')); ?></a>
                 </li>
                 <li class="nav-item d-lg-none">
                   <a href="<?php echo e(route('flight-booking')); ?>" class="nav-link"><i class="fas fa-plane"></i> <?php echo e(__('frontend.my_flight_bookings')); ?></a>
                 </li>
                 <li class="nav-item d-lg-none">
                   <a href="<?php echo e(url('change-password')); ?>" class="nav-link"><i class="fas fa-key"></i> <?php echo e(__('frontend.change_password')); ?></a>
                 </li>
                 <li class="nav-item d-lg-none">
                   <a href="<?php echo e(route('payment-history')); ?>" class="nav-link"><i class="fas fa-credit-card"></i> <?php echo e(__('frontend.payment_history')); ?></a>
                 </li>
                 <li class="nav-item d-lg-none">
                   <a href="<?php echo e(route('logout')); ?>" class="nav-link" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fas fa-sign-out-alt"></i> <?php echo e(__('frontend.logout')); ?></a>
                 </li>
                 <?php endif; ?>
...
<?php /**PATH /home/u394640813/domains/nomalytravel.com/public_html/resources/views/livewire/common/navbar.blade.php ENDPATH**/ ?>