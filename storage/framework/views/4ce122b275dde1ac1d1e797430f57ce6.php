            ...
            <?php echo csrf_field(); ?>
                ...
                <div class="form-outline mb-4 mt-4">
                     <div class="account-form-label"><label>Your Email</label></div>
                        ...
                        <div class="invalid-feedback"><?php echo e($errors->first('email') ?? 'Please enter a valid email address.'); ?></div>
                     </div>
                ...
                <div class="form-outline mb-3">
                    ...
                    <div class="invalid-feedback"><?php echo e($errors->first('password') ?? 'Please enter your password.'); ?></div>
                </div>
                ...
                <div class="account-bottom-text mt-5">
                    <p>Don't have an account?  <a href="<?php echo e(url('/register')); ?>">Sign Up for free</a></p>
                </div>
...
<?php endif; ?>
<?php /**PATH /home/u394640813/domains/nomalytravel.com/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>