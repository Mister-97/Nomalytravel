    ...
    <form action="<?php echo e(url('/flights/search')); ?>" method="GET">
        <div class="flightinthero">
            <div class="container">
                ...
                <h1><?php echo e(__('frontend.search_flights')); ?></h1>
                <div class="duffeltopsearch">
                    ...
                    <div class="tripetype" role="group">
                        <input type="radio" class="btn-check" name="triptype" id="onewayflight" value="oneway"
                            <?php echo e(isset($triptype) && $triptype == 'oneway'
                                ? 'checked'
                        ...
                        <input type="radio" class="btn-check" name="triptype" id="twowayflight" value="twoway"
                            <?php echo e(isset($triptype) && $triptype == 'twoway' ? 'checked' : ''); ?>>
                        ...
                        <input type="radio" class="btn-check" name="triptype" id="Multi-city" value="Multicity"
                            <?php echo e(isset($triptype) && $triptype == 'Multicity' ? 'checked' : ''); ?>>
                    ...
                    <div class="row single-city">
                        <div class="col">
                            <div class="mt-3">
                                ...
                                <input type="hidden" name="slices[0][from]" class="from_code" id="from_code"
                                    value="<?php echo e($slices[0]['from'] ?? ''); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="mt-3">
                                ...
                                <input type="text" name="slices[0][travelling_date]" id="travelling_date"
                                    ...
                                    value="<?php echo e($slices[0]['travelling_date'] ?? ''); ?>" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col return-date" <?php if(request('triptype') != 'twoway'): ?> style="display: none;" <?php endif; ?>>
                            <div class="mt-3">
                                <label>Return</label>
                                <input name="return_date" type="text" id="return_date" class="form-control"
                                    placeholder="Select Return Date" value="<?php echo e(request('return_date')); ?>"
                                    autocomplete="off">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mt-3">
                                ...
                                <select class="form-control" name="cabin_class">
                                    ...
                                    <option value="premium_economy"
                                        <?php echo e(request('cabin_class') == 'premium_economy' ? 'selected' : ''); ?>>Premium
                                        Economy</option>
                                    <option value="business"
                                        <?php echo e(request('cabin_class') == 'business' ? 'selected' : ''); ?>>Business</option>
                                    <option value="first" <?php echo e(request('cabin_class') == 'first' ? 'selected' : ''); ?>>
                                        First Class</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="mt-3">
                                ...
                                <input type="number" class="form-control" name="adults" min="1"
                                    max="9" value="<?php echo e(request('adults', 1)); ?>">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="mt-3">
                                ...
                                <input type="number" class="form-control" name="children" min="0"
                                    max="9" value="<?php echo e(request('children', 0)); ?>">
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-9">
                     ...
                     <div class="sortingbox sticky-top" id="filter-bar" <?php if(request()->path() === 'flights' && count(request()->query()) === 0): ?> style="display:none" <?php endif; ?>>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                    ...
                                    <select class="form-select form-control" name="sort_by" id="sort_by">
                                        <option value="best"
                                            <?php echo e(request('sort_by') == 'best' || !request('sort_by') ? 'selected' : ''); ?>>Best</option>
                                        <option value="price_asc"
                                            <?php echo e(request('sort_by') == 'price_asc' ? 'selected' : ''); ?>>Cheapest
                                        </option>
                                        <option value="price_desc"
                                            <?php echo e(request('sort_by') == 'price_desc' ? 'selected' : ''); ?>>Most Expensive
                                        </option>
                                        <option value="duration_asc"
                                            <?php echo e(request('sort_by') == 'duration_asc' ? 'selected' : ''); ?>>Fastest
                                        </option>
                                        <option value="duration_desc"
                                            <?php echo e(request('sort_by') == 'duration_desc' ? 'selected' : ''); ?>>Longest
                                            Duration
                                        </option>
                                    </select>
                            </div>
                            ...
                            <div class="col-md-3">
                                    ...
                                    <select name="max_connections" id="max_connections" class="form-control form-select">
                                        <option value=""
                                            <?php echo e(empty(request('max_connections')) ? 'selected' : ''); ?>>
                                            Any Stops
                                        </option>
                                        <option value="0"
                                            <?php echo e(request('max_connections') === '0' ? 'selected' : ''); ?>>
                                            Non-stop Only
                                        </option>
                                        <option value="1"
                                            <?php echo e(request('max_connections') === '1' ? 'selected' : ''); ?>>
                                            1 Stop or Less
                                        </option>
                                        <option value="2"
                                            <?php echo e(request('max_connections') === '2' ? 'selected' : ''); ?>>
                                            2 Stops or Less
                                        </option>
                                    </select>
                            </div>
                            ...
                            <div class="col-md-4">
                                    ...
                                    <select name="airline" id="airline" class="form-control">
                                        <option value="" <?php echo e(request('airline') == null ? 'selected' : ''); ?>>All Airlines</option>
                                        <?php
                                        ...
                                        ?>
                                        <?php if(count($usAirlineFound) > 0): ?>
                                            <optgroup label="US Airlines">
                                            <?php $__currentLoopData = $usAirlineFound; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $al): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($al['id']); ?>" <?php echo e(request('airline') == $al['id'] ? 'selected' : ''); ?>><?php echo e($al['name']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </optgroup>
                                        <?php endif; ?>
                                        <?php if(count($otherAirlines) > 0): ?>
                                            <optgroup label="International">
                                            <?php $__currentLoopData = $otherAirlines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $al): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($al['id']); ?>" <?php echo e(request('airline') == $al['id'] ? 'selected' : ''); ?>><?php echo e($al['name']); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </optgroup>
                                        <?php endif; ?>
                        ...
                        <div id="flight-results">
                            ...
                            <?php else: ?>
                                <div class="search-results-header mb-4 text-center">
                                    <h2>Showing <?php echo e(count($flights ?? [])); ?> Search Results</h2>
                                </div>

                                <?php if(count($flights ?? []) > 0): ?>
                                    <div class="flights-list">
                                        <?php $__currentLoopData = $flights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $flight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="nm-flight-card <?php echo e($index >= 6 ? 'd-none extra-flight' : ''); ?>" data-index="<?php echo e($index); ?>">
                                  <div class="nm-card">

                                    
                                    <div class="nm-airline">
                                      <img src="<?php echo e($flight['owner']['logo_symbol_url'] ?? ''); ?>"
                                           alt="<?php echo e($flight['owner']['name'] ?? 'Airline'); ?>"
                                           onerror="this.style.display='none'">
                                      <div class="nm-airline-name"><?php echo e($flight['owner']['name'] ?? ''); ?></div>
                                      <div class="nm-cabin-badge">
                                        <?php echo e($flight['slices'][0]['segments'][0]['passengers'][0]['cabin_class_marketing_name'] ?? 'Economy'); ?>
                                    ...
                                    <div class="nm-routes">
                                      <?php $__currentLoopData = $flight['slices']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $si => $slice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <div class="nm-route-row">
                                          <div class="nm-ep">
                                            <div class="nm-time"><?php echo e($depFormatted); ?></div>
                                            <div class="nm-iata"><?php echo e($depIata); ?></div>
                                            <div class="nm-city-name"><?php echo e($slice['origin']['city_name'] ?? ''); ?></div>
                                            <div class="nm-route-date"><?php echo e(date('D d M', strtotime($dep))); ?></div>
                                          </div>
                                          <div class="nm-path">
                                            <?php if($durLabel): ?><div class="nm-dur"><?php echo e($durLabel); ?></div><?php endif; ?>
                                            ...
                                            <div class="nm-stops-lbl <?php echo e($stops === 0 ? 'nm-direct' : ''); ?>">
                                              <?php echo e($stops === 0 ? 'Non-stop' : $stops.' stop'.($stops>1?'s':'')); ?>

                                            </div>
                                          </div>
                                          <div class="nm-ep nm-ep-right">
                                            <div class="nm-time"><?php echo e($arrFormatted); ?></div>
                                            <div class="nm-iata"><?php echo e($arrIata); ?></div>
                                            <div class="nm-city-name"><?php echo e($slice['destination']['city_name'] ?? ''); ?></div>
                                            <div class="nm-route-date"><?php echo e(date('D d M', strtotime($arr))); ?></div>
                                          </div>
                                        </div>
                                        <?php if(!$loop->last): ?><hr class="nm-slice-hr"><?php endif; ?>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    ...
                                    <div class="nm-price-col">
                                      <div class="nm-amount"><?php echo e(number_format((float)($flight['total_amount'] ?? 0), 0)); ?></div>
                                      <div class="nm-curr"><?php echo e($flight['total_currency'] ?? 'USD'); ?></div>
                                      <div class="nm-per">per person &middot; total fare</div>
                                      <a href="<?php echo e(route('flights.booking.form', trim($flight['id']))); ?>"
                                         class="nm-book-btn"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="hotelwidget" style="background: url(<?php echo e($img); ?>) no-repeat;">
                                <h2><?php echo e($widget->extra_field_1); ?></h2>
                                <h3><?php echo e($widget->description); ?></h3>
...
<?php $__env->stopPush(); ?>
    <?php $__env->startPush('js'); ?>
            ...
            // Google Flights-style airport autocomplete
            var nmAirportSearchUrl = "<?php echo e(route('flights.search.airports')); ?>";
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.select-flight-btn').click(function(e) {
                    ...
                    const bookingUrl = '<?php echo e(route("flights.booking.form", "__ID__")); ?>'.replace('__ID__', offerId);
...
<?php endif; ?>
<?php /**PATH /home/u394640813/domains/nomalytravel.com/public_html/resources/views/flights/offers.blade.php ENDPATH**/ ?>