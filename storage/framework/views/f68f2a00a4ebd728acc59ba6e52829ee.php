            ...
            <div class="row g-2 align-items-stretch">
              ...
              <div class="col-6 col-md-2">
                <div class="nm-gf-field">
                  ...
                  <input type="date" id="nm-depart" min="<?php echo e(date('Y-m-d')); ?>">
                </div>
              </div>
            ...
            <div class="row g-2 align-items-stretch">
              ...
              <div class="col-6 col-md-2">
                <div class="nm-gf-field">
                  ...
                  <input type="date" id="nm-sp-date" min="<?php echo e(date('Y-m-d')); ?>">
                </div>
              </div>
          ...
          <div id="panel-concerts" class="nm-gf-panel d-none">
            <div class="row g-2 align-items-stretch">
              ...
              <div class="col-6 col-md-2">
                <div class="nm-gf-field">
                  <label><i class="fas fa-calendar"></i>Date</label>
                  <input type="date" id="nm-co-date" min="<?php echo e(date('Y-m-d')); ?>">
                </div>
              </div>
              <div class="col-12 col-md-auto d-flex align-items-stretch" style="min-width:160px">
...
function _nmInitStripe() {
    _nmStripe = Stripe('<?php echo e(env('STRIPE_KEY')); ?>');
...
<?php endif; ?>
<?php /**PATH /home/u394640813/domains/nomalytravel.com/public_html/resources/views/welcome.blade.php ENDPATH**/ ?>